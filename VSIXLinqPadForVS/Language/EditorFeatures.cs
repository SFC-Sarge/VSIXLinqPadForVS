...
namespace VSIXLinqPadForVS
{
    ...
    public class SyntaxHighligting : TokenClassificationTaggerBase
    {
        ...
        {
            { LinqClassificationTypes.MarkdownHeader, LinqClassificationTypes.MarkdownHeader },
            { LinqClassificationTypes.MarkdownCode, LinqClassificationTypes.MarkdownCode },
            { LinqClassificationTypes.MarkdownHtml, LinqClassificationTypes.MarkdownHtml },
            { LinqClassificationTypes.MarkdownComment, LinqClassificationTypes.MarkdownComment },
            { LinqClassificationTypes.MarkdownLink, LinqClassificationTypes.MarkdownLink },
            { LinqClassificationTypes.MarkdownItalic, LinqClassificationTypes.MarkdownItalic },
            { LinqClassificationTypes.MarkdownStrikethrough, LinqClassificationTypes.MarkdownStrikethrough },
            { LinqClassificationTypes.MarkdownBold, LinqClassificationTypes.MarkdownBold },
            { LinqClassificationTypes.MarkdownQuote, LinqClassificationTypes.MarkdownQuote },
        };
    }
