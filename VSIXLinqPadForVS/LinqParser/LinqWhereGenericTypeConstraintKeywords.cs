...
// Version Number   :
// Description      :
// File Name        : LinqWhereGenericTypeConstraintKeywords.cs
...
{
    /// <summary>Class LinqWhereGenericTypeConstraintKeywords</summary>
    /// <remarks>
    /// <para><b>History:</b></para>
    /// <list type="table">
    /// <item>
    ...
    /// </list>
    /// </remarks>
    public class LinqWhereGenericTypeConstraintKeywords
    {
        // Where Generic Type Constraint Keywords Reference URL: (https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/where-generic-type-constraint)
        /// <summary>The where generic type constraint keywords</summary>
        /// <remarks>
        /// <para><b>History:</b></para>
        /// <list type="table">
        /// <item>
        ...
        /// </list>
        /// </remarks>
        public static readonly string[] WhereGenericTypeConstraintKeywords = "where".Split().ToArray();

        /// <summary>Enum CSharp_WhereGenericTypeConstraintKeywords
        /// </summary>
        /// <remarks>
        /// <para><b>History:</b></para>
        /// <list type="table">
